...
export default class EditListing extends Component{
    ...
    onButtonPress() {
        if (this.state.title === "" || this.state.condition === "" || this.state.price === 0) {
            ...
            //TODO: API call to submit and redirect to RootNavigator-ActiveListing
            Alert.alert("Edit Listing book: " + this.state.title)
        }
    }
            ...
            <SafeAreaView style={[styles.container,{marginTop:'10%'}]}>
                <KeyboardAwareScrollView behavior="padding">
                    ...
                    <TextInput
                        ...
                        clearButtonMode={"while-editing"}
                        keyboardType="number-pad"
                        value={this.props.route.params.price.toString()}
