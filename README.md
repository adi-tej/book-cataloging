...
![](media/image1.png){width="2.5in" height="2.5in"}

**COMP9323 Software as a Service**
...
[1. System Requirements 3](#_Toc48299032)

[2. Deploying system package 3](#deploying-system-package)

[2.1 Get app package from GitHub with Https
3](#get-app-package-from-github-with-https)

[2.2 Setup and Deployment backend 3](#setup-and-deployment-backend)

[2.3 Setup and Deployment Frontend 4](#setup-and-deployment-frontend)

[3. Production Details (Only for Android)
7](#production-details-only-for-android)

[3.1 Swagger API Documentation 7](#swagger-api-documentation)

[3.2 App 7](#app)

[4. Instructions for using the app 8](#instructions-for-using-the-app)

[4.1 Login CircEx Book Cataloguing app 8](#_Toc48299042)

[4.2 List items on eBay 8](#_Toc48299046)

[4.3 Editing/Removing existing book items
10](#editingremoving-existing-book-items)

[4.4 Deal with in-store orders (Checkout)
11](#deal-with-in-store-orders-checkout)

[4.5 Deal with online orders from eBay
13](#deal-with-online-orders-from-ebay)

[4.6 Search 13](#search)

[5. Work in Progress 14](#work-in-progress)
